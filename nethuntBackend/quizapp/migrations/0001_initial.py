...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event', models.CharField(choices=[('Login', 'LOGIN'), ('Thiran', 'THIRAN')], default='Thiran', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.CharField(choices=[('Easy', 'EASY'), ('Moderate', 'MODERATE'), ('Hard', 'HARD')], default='Easy', max_length=50)),
